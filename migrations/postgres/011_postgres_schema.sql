...
CREATE TABLE IF NOT EXISTS cultivators (
    ...
    realm_tier                        INTEGER NOT NULL DEFAULT 1 CHECK (realm_tier BETWEEN 1 AND 9),
    realm_sub_stage                   INTEGER NOT NULL DEFAULT 1 CHECK (realm_sub_stage BETWEEN 1 AND 4),
