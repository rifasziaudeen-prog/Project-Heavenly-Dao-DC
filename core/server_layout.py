...
ROLES_SPEC: list[dict] = [
    ...
    {"name": "🌿 Tier 2: Qi Condensation 炼气", "color": "dark_teal", "hoist": False, "admin": False,
     "self_assignable": False, "mentionable": False, "permissions": []},
    {"name": "🪨 Tier 3: Foundation Establishment 筑基", "color": "teal", "hoist": False, "admin": False,
     "self_assignable": False, "mentionable": False, "permissions": []},
    {"name": "🔥 Tier 4: Core Formation 金丹", "color": "gold", "hoist": False, "admin": False,
     "self_assignable": False, "mentionable": False, "permissions": []},
    {"name": "💎 Tier 5: Nascent Soul 元婴", "color": "purple", "hoist": False, "admin": False,
     "self_assignable": False, "mentionable": False, "permissions": []},
    {"name": "🌌 Tier 6: Soul Transformation 化神", "color": "dark_purple", "hoist": False, "admin": False,
     "self_assignable": False, "mentionable": False, "permissions": []},
    {"name": "🔮 Tier 7: Void Refinement 炼虚", "color": "dark_magenta", "hoist": False, "admin": False,
     "self_assignable": False, "mentionable": False, "permissions": []},
    {"name": "👑 Tier 8: Dao Fusion 合体", "color": "dark_gold", "hoist": False, "admin": False,
     "self_assignable": False, "mentionable": False, "permissions": []},
    {"name": "⚡ Tier 9: Tribulation Transcendence 渡劫", "color": "red", "hoist": False, "admin": False,
     "self_assignable": False, "mentionable": False, "permissions": []},
    {"name": "☀️ Tier 10: True Immortal 真仙", "color": "lighter_grey", "hoist": False, "admin": False,
     "self_assignable": False, "mentionable": False, "permissions": []},
    {"name": "🌟 Tier 11: Golden Immortal 金仙", "color": "dark_gold", "hoist": False, "admin": False,
     "self_assignable": False, "mentionable": False, "permissions": []},
    {"name": "🌀 Tier 12: Primordial Chaos 混沌", "color": "dark_purple", "hoist": False, "admin": False,
     "self_assignable": False, "mentionable": False, "permissions": []},
    {"name": "🐉 Tier 13: Dao Ancestor 道祖", "color": "dark_teal", "hoist": False, "admin": False,
     "self_assignable": False, "mentionable": False, "permissions": []},
    {"name": "⛩️ Tier 14: Heavenly Venerable 天尊", "color": "purple", "hoist": False, "admin": False,
     "self_assignable": False, "mentionable": False, "permissions": []},
    {"name": "👑 Tier 15: Great Emperor 大帝", "color": "gold", "hoist": False, "admin": False,
     "self_assignable": False, "mentionable": False, "permissions": []},
    {"name": "☯️ Tier 16: Beyond Dao 超脱", "color": "blurple", "hoist": True, "admin": False,
     "self_assignable": False, "mentionable": False, "permissions": []},
